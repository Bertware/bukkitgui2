...
Public Class ChangelogInfo
    ...
    Public Sub Load(program As String, startversion As String, stopversion As String)
        ...
        Dim response = GetAPIResponse(APIAction.changelog, p)
    ...
    Public Sub LoadThis(startversion As String, stopversion As String)
        Load(Assembly.GetEntryAssembly.GetName.Name, startversion, stopversion)
    End Sub
    ...
    Private Sub LoadXML(xml As String)
        Try
            ...
            For Each element As XmlElement In xmldoc.DocumentElement.GetElementsByTagName("change")
                Try
                    Changes.Add(New Change([Enum].Parse(GetType(Change.changeType), element.Attributes("type").Value),
                                           element.Attributes("version").Value, element.InnerText))
...
Public Class Change
    ...
    Public Overrides Function ToString() As String
        If Description.Length > 50 Then Return Type.ToString + ": " + Description.Substring(0, 47) + "..." Else _
