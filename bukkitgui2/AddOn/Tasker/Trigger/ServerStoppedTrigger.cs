// ServerStoppedTrigger.cs in bukkitgui2/bukkitgui2
// Created 2014/08/14
...
{
	internal class ServerStoppedTrigger : ITrigger
	{
		public ServerStoppedTrigger()
		{
			Name = "Server stopped";
			Description = "Execute a task when the server has stopped";
		...
		public void Enable()
		{
			ProcessHandler.ServerStopped += OnTaskerTriggerFired;
			Enabled = true;
		}
