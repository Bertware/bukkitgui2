// PlayerJoinedTrigger.cs in bukkitgui2/bukkitgui2
// Created 2014/09/07
// 
...
{
    internal class PlayerJoinedTrigger : ITrigger
    {
        public PlayerJoinedTrigger()
        {
            Name = "Player join";
            Description = "Execute a task when a player joins";
        ...
        public void Enable()
        {
            PlayerHandler.PlayerListAddition += (p => OnTaskerTriggerFired());
            Enabled = true;
        }
