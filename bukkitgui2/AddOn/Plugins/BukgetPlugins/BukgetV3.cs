...
namespace Bukkitgui2.AddOn.Plugins.BukgetPlugins
{
	internal class BukgetV3
	{
		...
		public static readonly Field[] FieldsAll =
		{
			...
			Field.Vf_Date,
			Field.Vf_Slug,
			Field.Vf_Soft_Dependencies,
			Field.Vf_Hard_Dependencies
		};
		...
		public static string ConstructUrl(Category category, Field[] field, Field sortField, Boolean negateSort, int limit)
		{
