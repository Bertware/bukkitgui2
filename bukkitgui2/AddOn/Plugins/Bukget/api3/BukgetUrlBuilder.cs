...
namespace Net.Bertware.Bukkitgui2.AddOn.Plugins.Bukget.api3
{
	...
	internal static class BukgetUrlBuilder
	{
		...
		/// <param name="limit">the maximum amount or results</param>
		/// <returns>The URL to make the api call to, as a string</returns>
		public static string ConstructUrl(PluginInfoField[] field, PluginInfoField sortField, Boolean negateSort, int limit)
		{
		...
		/// <param name="limit">the maximum amount or results</param>
		/// <returns>The URL to make the api call to, as a string</returns>
		public static string ConstructUrl(PluginCategory pluginCategory, PluginInfoField[] field, PluginInfoField sortField,
			int limit)
		{
