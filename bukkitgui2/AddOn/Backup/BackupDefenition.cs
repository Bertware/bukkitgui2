...
namespace Net.Bertware.Bukkitgui2.AddOn.Backup
{
	public class BackupDefenition
	{
		...
		public BackupDefenition LoadXml(XmlElement xmle)
		{
			...
			MessageBox.Show(
				Locale.Tr("One of your backup profiles wasn't loaded: the file is probably corrupt! The backup profile was removed."),
		...
		public void Execute()
		{
			...
			string backupfolder = "\\backup_" + this.Name + "_" + DateTime.Now.Ticks;
